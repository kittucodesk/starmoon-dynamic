...
import { Play, Check, Star, Users, Zap, Shield, ArrowRight, ChevronDown, ChevronUp, Video } from "lucide-react"
...
export default function ProductDetailPage() {
    ...
    const features = [
        {
            ...
            description:
                "Get deep insights into your project performance with real-time analytics and customizable dashboards.",
    ...
    const benefits = [
        ...
        { icon: Users, title: "Enhanced Collaboration", description: "Improve team coordination and communication" },
        { icon: Shield, title: "Enterprise Security", description: "Bank-level security with SOC 2 compliance" },
    ]
    ...
    const faqs = [
        {
            ...
            answer:
                "You can be up and running in under 15 minutes. Our onboarding process includes guided setup, data migration assistance, and dedicated support.",
        },
        {
            question: "What integrations are available?",
            answer:
                "We integrate with 100+ popular tools including Slack, GitHub, Jira, Salesforce, and all major cloud platforms. Custom integrations are also available.",
        },
        {
            question: "Is my data secure?",
            answer:
                "Absolutely. We use enterprise-grade encryption, maintain SOC 2 compliance, and offer single sign-on (SSO) integration with your existing security infrastructure.",
        },
        {
            question: "What support do you provide?",
            answer:
                "We offer 24/7 support, dedicated customer success managers, comprehensive documentation, and regular training sessions for your team.",
        },
    ]
        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white container">
            ...
            <section className="container mx-auto px-4 py-16 lg:py-24">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <Badge className="mb-4 bg-blue-100 text-blue-700 hover:bg-blue-100">Project Management Platform</Badge>
                        <h1 className="text-4xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-slate-900 to-slate-600 bg-clip-text text-transparent">
                            Transform Your Project Management
                        </h1>
                        <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                            Streamline workflows, boost team productivity, and deliver projects faster with our comprehensive project
                            management platform trusted by 10,000+ companies worldwide.
                        </p>
                    ...
                    <div className="relative">
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                            <video width="320" height="240" autoPlay loop muted className="w-full">
                                <source src="/Products/projectmanagement.mp4" type="video/mp4" />
                                <track
                                    src="/Products/projectmanagement.mp4"
                                    // kind="subtitles"
                                    srcLang="en"
                                    label="English"
                                />
            ...
            <section className="container mx-auto px-4 py-16">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                        <Image
                            src="/Products/projectmanagement1.jpg"
                            alt="Video Demo"
                            width={800}
                            height={700}
                            className="w-full"
            ...
            {/* Final CTA Section */}
            <section className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-16 rounded-sm">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Button
                            size="lg"
                            variant="outline"
                            className="text-lg px-8 border-white text-white bg-blue-600 hover:bg-white hover:text-blue-600"
                        >
                            Contact Sales
                        </Button>
                    </div>
                    ...
                    <div className=" container flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div className="text-center sm:text-left">
                            <div className="font-bold text-xl text-blue-600">
                                ₹4900 <span className="text-base text-muted-foreground"> user/month</span>
                            </div>
